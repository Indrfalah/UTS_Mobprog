...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Pil = new String[] {"Blackforest", "Kitkat Chacha", "Chocochips", "Cokelat"};
        Gbr = new String[] {
                Integer.toString(R.drawable.blackforest),
                Integer.toString(R.drawable.kitkat),
                Integer.toString(R.drawable.chocochips),
